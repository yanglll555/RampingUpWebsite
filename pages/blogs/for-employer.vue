...
export default({
    ...
    methods: {
        ...
        getList() {
            const url = 'https://strapi.runworld.com.cn/api/blogs?pagination[pageSize]=100&populate=authors,cover&filters[type][$eq]=for employer'
            fetch(url, {
                method: 'GET',
                headers: {
...
@media (max-width: 600px) {
    ...
    .blog .banner-box {
        padding: 62px 0;
        height: 365px;
        background-image: url('@/assets/images/blogs_banner_back1_h5.png');
...
@media (min-width: 600px) {
    ...
    .banner-box {
        padding: 100px 0;
        background-image: url('@/assets/images/blogs_banner_back1.png');
		background-repeat: no-repeat;
		background-size: 100%;
    }
    .banner-box .title {
